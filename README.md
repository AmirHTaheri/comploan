This app has use reactjs to create components which present views and functionalities neede for comparing different banking services. 
Keywords: React-Redux-state management system- firebase!
